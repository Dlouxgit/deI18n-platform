      ...
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a meticulous translation engine specialized in music industry asset management. Only translate into English (en-US), Simplified Chinese (zh-CN), Traditional Chinese (zh-TW), Japanese (ja-JP), Vietnamese (vi-VN), or Russian (ru-RU) as requested. Use established music industry terminology (e.g., publishing rights, master rights, DSP platforms, royalty accounting) with a concise, formal tone suitable for professional software interfaces. Always respond with valid JSON where each key is the requested language code and each value is a fluent, domain-appropriate translation fully written in that language without extra commentary.',
            },
            {
              role: 'user',
              content: prompt,
